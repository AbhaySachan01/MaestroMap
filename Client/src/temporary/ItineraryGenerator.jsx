...
const UNWANTED_PLACE_KEYWORDS = ["school", "bank", "atm", "college", "university", "post office"];
...
export default function ItineraryGenerator() {
  ...
  // --- HELPER FUNCTION to fetch nearby places with updated filtering ---
  const fetchPlaces = async (place, types, limit) => {
    ...
    try {
      ...
      return Array.isArray(data)
        ? data
            // Updated: Add the robust filtering logic here.
            .filter(p => {
